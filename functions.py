...
def send_gulat_message(bot,event,nam,baza,chat,gender):
	...
	if event == 0:
		...
		markup.add(switch_button1)
		markup.add(switch_button2)
		text = 'Прогуливаясь, вы заметили странную коробку посреди дороги. ' + cnam + ' сразу же предложила открыть её. На самом деле, тебе и самому интересно что там внутри'
		if gender == 1:
			text = 'Прогуливаясь, вы заметили странную коробку посреди дороги. ' + cnam + ' сразу же предложил открыть её. На самом деле, тебе и самому интересно что там внутри'
		...
		markup.add(switch_button1)
		markup.add(switch_button2)
		text = 'Да это же целый мешок вискаса 🍫! ' + cnam + ' облизывается смотря на него. Этого хватит раза на четыре точно\n\nСтоимость:  25 некогривен 💰'
		if baza >= 7:
			text = 'Да это же целый мешок вискаса 🍫! ' + cnam + ' облизывается смотря на него. Этого хватит раз на пять точно\n\nСтоимость:  25 некогривен 💰'
