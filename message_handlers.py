...
def msg_text(message,bot):
		...
		if data is None:
			if cmd == 'неко':
				...
				time.sleep(3)
				text = "Твоя заявка на гражданство Некославии была одобрена и, как гражданину, мы выдаём тебе личную кошкожену. Напиши <i><u>неко</u></i> чтобы взглянуть на неё. Не забывай, что ключ к хорошим отношениям с твоей некодевочкой это <b>доверие 💞</b>. Его можно повысить многими способами, для начала попробуй дать некодевочке поесть командой <i><u>покормить</u></i>, скорее всего она проголодалась пока ехала к тебе. После этого советую придумать ей какую-нибудь пиздатую кличку командой <i><u>имя [текст]</u></i>"
