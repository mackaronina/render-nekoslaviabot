...
def msg_text(message,bot):
		...
		if cmd == 'неко':
			...
			text = 'Очевидно, бои некочанов нелегальны, поэтому опустим лишние подробности. Обязательным условием проведения боя является ставка, часть которой организаторы забирают себе\nЛучшие некочаны арены:\n\n'
			...
			markup = types.InlineKeyboardMarkup()
			switch_button1 = types.InlineKeyboardButton(text='Бой 🗡', switch_inline_query_current_chat = "Бой")
			markup.add(switch_button1)
